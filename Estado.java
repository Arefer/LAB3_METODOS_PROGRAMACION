...
public class Estado{
	...
	// Métodos
	// Constructores
	// Constructor para un estado inicial en busqueda de una palabra especificada
	...
	// Constructor para un estado no inicial en busqueda de una palabra especificada
	...
	public ArrayList<Estado> buscarAdyacentes(String palabra, char[][] sopa){
		...
		if(palabra.length() > this.indiceActual+1){
			...
			if (this.estadoAnterior != null){
			 	estadoActual.estadoAnterior = this.estadoAnterior;	
			}
				
			// Generar estados para encontrar la palabra especificada
