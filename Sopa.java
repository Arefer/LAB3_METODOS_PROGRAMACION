...
public class Sopa{
	...
	public boolean agregarEstado(Estado candidato){
		...
		for (Estado cerrado: this.CERRADOS){
			if(cerrado.i == candidato.i && cerrado.j == candidato.j){
				Estado estadoAnterior = candidato.estadoAnterior;
				while (estadoAnterior != null){
					if (estadoAnterior.i == candidato.i && estadoAnterior.j
						== candidato.j){
						return false;
					}
	...
	*/ 
	public ArrayList<String> resolverSopa(ArrayList<String> palabras){
	...
	*/
	public ArrayList<String> noEncontradas(ArrayList<String> palabrasABuscar, ArrayList<String> encontradas){
